...
const char COMMUNITY_FORUM_URL[] = "https://forum.getmonetaverde.org";
const char REPORT_ISSUE_URL[] = "https://github.com/campurro/monetaverde-wallet/issues";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Monetaverde Wallet %1").arg(Settings::instance().getVersion()));
